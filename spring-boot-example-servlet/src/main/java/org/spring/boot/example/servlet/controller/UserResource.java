package org.spring.boot.example.servlet.controller;


import org.spring.boot.example.servlet.bean.User;
...
public class UserResource {
    ...
    @Path("/say/{arg}")
    @Produces("application/json")
    public Response say(@PathParam("arg") String arg){
        return Response.status(200).entity("Say,"+arg).build();
    }
