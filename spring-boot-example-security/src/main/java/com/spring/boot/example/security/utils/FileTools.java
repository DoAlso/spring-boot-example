package com.spring.boot.example.security.utils;
...
import com.spring.boot.example.security.bean.Base64DecodeMultipartFile;
...
public class FileTools {
    ...
    public static boolean isRar(File file){
        ...
        if(file.getName().substring(file.getName().lastIndexOf(".")+1).equals("rar")){
            return true;
        }
        return false;
    }
     ...
     * @return
     */
//    public static Map<String,File> unzip(File file) {
...
//                String objectKey = entry.getName().substring(entry.getName().lastIndexOf("/") + 1);
//                String extName = objectKey.substring(objectKey.lastIndexOf(".") + 1);
//                if(ConstantUtil.File.getImgExt().contains(extName)){
//                    File imageFile = new File(objectKey);
...
//    }
    ...
    public static void main(String[] args) {
        File file = new File("e:\\redis.rar");
        FileType fileType = FileTools.getFileType(file);
